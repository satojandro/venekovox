...
| S2.2 wallet compatibility | Planned, smart-wallet coding paused for docs                                 | EOA and candidate smart account use actual caller consistently; viable sponsorship and SDK path demonstrated before S2.1 binding is frozen                                                                                                                                                                              |
| S2.1 eligibility          | Self verifier exists; bridge missing                                         | G01/G09/G10 resolved; eligible passes, bypass/replay/wrong-account fail; policy and uniqueness decisions recorded                                                                                                                                                                                                       |
...
| D06 | Candidate            | Privy embedded/smart wallets and a paymaster. Vendor/account type/implementation are not finalized or shipped. Smart-wallet coding is paused while documentation review completes.                                                                                                                                                                                                                                                                                                                                          |
