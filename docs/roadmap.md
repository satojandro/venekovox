...
| ------------------------- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| P1 reliable submission    | Core flow implemented; 19 flow/receipt tests pass  | Repair G02–G04/G11; real submit → refresh → reconnect; no stale-account confirmation or false unregistered state                         |
