...
| D15 | Deferred             | Discussions/resources after reliable polling; moderation and separation from ballots are required. Vote-reason harvesting, demographic microsegments and monetization of individual opinions are outside initial scope.          |
