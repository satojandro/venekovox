...
const content = {
  en: {
    ...
    hero: {
      ...
      subheadline:
        "VenekoVox lets you speak your truth—without fear, without censorship. Built from exile, for dignity.",
    ...
    testimonials: {
      ...
      quotes: [
        {
          text: "For the first time in 25 years, I feel like my vote actually counts.",
          author: "Anonymous, Venezuela",
        },
        {
          text: "This is what digital democracy is supposed to look like. Secure, private, and powerful.",
          author: "Anonymous, Colombia",
        },
  ...
  es: {
    ...
    hero: {
      ...
      subheadline:
        "VenekoVox te permite decir tu verdad—sin miedo, sin censura. Creado desde el exilio, para la dignidad.",
    ...
    testimonials: {
      ...
      quotes: [
        ...
        {
          text: "Así es como se debe ver la democracia digital. Segura, privada y poderosa.",
          author: "Anónimo, Colombia",
        },
    ...
    join: {
      ...
      subheadline:
        "Mantente actualizado sobre nuevas encuestas, resultados y el futuro de la tecnología cívica descentralizada.",
...
const TechLogo: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="h-8 text-gray-400 filter grayscale hover:grayscale-0 transition duration-300">{children}</div>
);
const MACILogo = () => (
  <TechLogo>
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      <title>MACI</title>
      <path d="M12 0L1.606 6v12L12 24l10.394-6V6L12 0zm-1.04 4.544h2.08v14.912h-2.08V4.544zM4.909 7.636l2.122-1.226 7.456 12.91-2.12 1.227-7.458-12.91zM16.969 6.41l2.121 1.226-7.456 12.91-2.12-1.227 7.455-12.91z" />
    </svg>
  </TechLogo>
);
const SemaphoreLogo = () => (
  <TechLogo>
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      ...
      <path d="M12 0L2.78 5.333v13.334L12 24l9.22-5.32V5.333L12 0zm0 21.6c-5.302 0-9.6-4.298-9.6-9.6S6.698 2.4 12 2.4s9.6 4.298 9.6 9.6-4.298 9.6-9.6 9.6zM12 4.114a.754.754 0 00-.652.376l-5.486 9.502a.752.752 0 00.652 1.128h10.972a.752.752 0 00.652-1.128l-5.486-9.502a.754.754 0 00-.652-.376zM12 14.726L12 14.726l-2.68 1.937v-3.87l2.68 2.247 2.68-2.247v3.87z" />
    </svg>
  </TechLogo>
);
const SelfIDLogo = () => (
...
const FilecoinLogo = () => (
  <TechLogo>
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 21.6c-5.302 0-9.6-4.298-9.6-9.6S6.698 2.4 12 2.4s9.6 4.298 9.6 9.6-4.298 9.6-9.6 9.6zM12 4.114a.754.754 0 00-.652.376l-5.486 9.502a.752.752 0 00.652 1.128h10.972a.752.752 0 00.652-1.128l-5.486-9.502a.754.754 0 00-.652-.376z" />
    </svg>
  </TechLogo>
);
const IPFSLogo = () => (
  <TechLogo>
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
      <title>IPFS</title>
      <path d="M12 0L2.78 5.333v13.334L12 24l9.22-5.333V5.333L12 0zm-1.04 4.545h2.08v14.91h-2.08v-14.91zm-4.24 2.122l2.12 1.226v10.057l-2.12-1.226V6.667zm8.48 0v10.057l-2.12 1.226V7.893l2.12-1.226z" />
    </svg>
  </TechLogo>
);
      ...
      <div className="bg-black text-gray-200 font-sans antialiased">
          ...
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">
                {currentContent.nav.mission}
              </a>
              <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">
                {currentContent.nav.howItWorks}
              </a>
              <a href="#" className="text-sm text-gray-300 hover:text-white transition-colors">
                {currentContent.nav.polls}
              </a>
            </nav>
            <button
        ...
        <section className="relative h-screen flex items-center justify-center text-center overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1590779720839-50b86a343603?auto=format&fit=crop&w=1500&q=80')",
            }}
          ></div>
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-10">
            <div className="relative">
              <div
                className="absolute w-64 h-64 border-2 border-blue-500 rounded-full animate-ripple"
                style={{ animationDelay: "0s" }}
              ></div>
              <div
                className="absolute w-64 h-64 border-2 border-blue-400 rounded-full animate-ripple"
          ...
          <div className="relative z-10 px-6 max-w-4xl mx-auto">
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">{currentContent.hero.subheadline}</p>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#"
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-8 rounded-lg transition-transform transform hover:scale-105"
              >
                {currentContent.hero.ctaVote}
              </a>
              <a
                href="#"
                className="w-full sm:w-auto bg-gray-800/50 border border-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-8 rounded-lg transition"
              >
        ...
        <section className="py-12 bg-black">
          <div className="container mx-auto px-6 text-center">
            <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-widest mb-6">
        ...
        <section className="py-20 bg-gray-900">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              {[currentContent.howItWorks.step1, currentContent.howItWorks.step2, currentContent.howItWorks.step3].map(
                (step, i) => (
        ...
        <section className="py-20 bg-gray-900">
          <div className="container mx-auto px-6 text-center max-w-3xl">
            ...
            <form className="mt-8 flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              <input
                type="email"
                placeholder={currentContent.join.placeholder}
                className="flex-grow w-full bg-gray-800 border border-gray-600 rounded-md py-3 px-4 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
                className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-6 rounded-md transition-transform transform hover:scale-105"
              >
        ...
        <footer className="bg-black border-t border-gray-800">
          <div className="container mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center text-sm">
            <p className="text-gray-500 mb-4 sm:mb-0">
              &copy; {new Date().getFullYear()} {currentContent.footer.rights}
            </p>
