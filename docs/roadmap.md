...
Stages 2/3 ahead of Stage 1. Next: connect actual Privy session/caller, configure merged naming,
mount ZKPassport evidence under D17, then deployment/submission/recovery and verified results.
...
| S2.1 eligibility          | Provider locked: ZKPassport (D17) is the mount path; Enterprise candidate unmounted; legacy route still active | G01/G09/G10 resolved; eligible passes, bypass/replay/wrong-account fail; policy and uniqueness decisions recorded (D17)                                                                                                                                                                                                 |
...
ENS integration update (2026-09-08): registration branch `3fd87a2e` is merged into the local frontend round; `/account/name` now mounts Names. Deployment, actual Privy caller and live verification remain open.
