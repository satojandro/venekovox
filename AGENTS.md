...
Docs were restructured 2026-09-13 for submission: judge-facing docs live at `docs/README.md` and `docs/technology.md`; agent/build records moved to `docs/archive/`.

Start with [agent continuity](docs/archive/agents.md), then the [as-built journey map](docs/archive/journey-map.md), [current status](docs/archive/status.md) and [roadmap and decisions](docs/roadmap.md). These replace the old 2025 task list and agent-specific persona instructions.

- Build the verified-human polling journey first. Read the relevant [integration specification](docs/archive/build.md) before changing identity, wallet, tally or schema boundaries.
