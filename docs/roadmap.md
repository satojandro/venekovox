...
| S3.2 real poll experience | Partial: one operator descriptor + on-chain window; results unavailable      | G05 resolved for one poll; correct options, schedule, eligibility and loading/error states                                                                                                                                                                                                                              |
