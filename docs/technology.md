...
| ZKPassport (D17 lock)             | 2 prove eligibility     | Eligibility proof (Stage 1): salted uniqueness + strict facematch | Core product foundation; no award assumed                            | Provider locked 2026-09-08; adapter + negatives on trial branch; Legacy route still active (G01 open) |
