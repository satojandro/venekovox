...
const chapters: Array<{
...
}> = [
  {
    ...
    body: "You shouldn’t need to introduce yourself with a long wallet address. Choose a readable name and control the records behind it. ENS gives your account a public name you can own.",
    scene: "introduction",
    steps: ["Choose a name", "Register ownership", "Control your records"],
    detailTitle: "What are the registry and resolver?",
    detail:
      "Think of the registry as an address book: it records who owns each name. The resolver holds the records that name points to, such as your account address. Scoped permissions limit which records someone else may edit. A name is optional and public; it does not prove you are a unique person or make blockchain activity private.",
  },
  {
    id: "human",
  ...
  return (
    <section className="technology-story" id="how-it-works" aria-labelledby="technology-title">
      <header className="technology-intro">
        ...
        <p>
          A name you control. Proof you can participate.
          <br />
