...
| [s41-tally-results-brief.md](s41-tally-results-brief.md)               | **S4.1 implementation brief (Cursor handoff):** verified tally → results. Machinery audit, work packages, and the finding that poll 1's coordinator key is irrecoverable |
| [ensv2-opportunities-2026-09-11.md](ensv2-opportunities-2026-09-11.md) | Background research only; not implementation authority for named accounts                                                                                                |
