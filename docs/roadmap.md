...
| W1 wallet compatibility   | Experiment scaffold (not approved architecture)          | E1–E6 in [w1-experiment.md](w1-experiment.md): prove actual caller vs outer tx, user-op vs bundle, durable ids, MACI steps together, denied sponsorship with no paid fallback. P1 EOA verifier stays as-is. |
...
2. Run the [W1 experiment protocol](w1-experiment.md) (Privy first; D06 provisional). Do not wire a vendor adapter or relax P1 until E1–E6 have evidence.
