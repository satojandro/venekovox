...
export default function Polls() {
  ...
  return (
    <main className="section-wrap explorer-page">
      <PollBoard explorer />
      <h2 className="configured-heading" id="configured-poll">Current deployment</h2>
      <div className="explorer-grid">
        <section className="poll-feature">
          ...
          {configured.phase === "unconfigured" && (
            <p>
              No live poll is bound to this app yet. You can still read how the journey works. Voting stays unavailable
              until a configured deployment can be checked on-chain.
            </p>
          )}
        ...
        <aside className="explorer-aside">
          ...
          <FieldNote title="What will I need?">
            <p>
              A browser wallet on Sepolia, test ETH for network fees, and the ZKPassport app with a supported document.
              Participation depends on this poll’s age and nationality rules. People outside that cohort can explore the
              site but cannot vote.
            </p>
          </FieldNote>
          <FieldNote title="Can I just look around?">
            <p>Yes. You can read the question and learn how the system works without connecting a wallet.</p>
          </FieldNote>
          <FieldNote title="What do the results represent?">
            <p>
              The people who choose to participate. These are self-selected opinion polls, not representative estimates
