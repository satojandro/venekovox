...
**Reviewed:** 2026-09-09. **Baseline:** `exp/provider-trial-self-vs-zkpassport`
tip `086c1b089` (D17 impl + lockfile + runnable trial server + D10 client fixes);
`main` `3b2d083b9` carries the D17/D18 decision register.
Snapshot, not live deployment monitoring.
...
| G10 | Backend dev CORS permits 5173/3002; default frontend port is 3000                                                                                                              | **Partial**: dev CORS now includes 3000/3001 as well as 5173/3002. Browser preflight and the public Self callback are still unverified. Do not treat this as Enterprise mounting.                                                                                                                                                                                                                                                                                                                               |
